            ...
            <header className="h-16 border-b border-white/5 flex items-center justify-between px-4 md:px-8 bg-background/50 backdrop-blur-sm sticky top-0 z-40">
                ...
                <div className="flex items-center gap-4">
                    <div className="hidden sm:flex flex-col items-end">
                        ...
                        <span className="text-xs font-black px-2 py-0.5 rounded bg-green-500/20 text-green-500">
                            UNLIMITED FREE 🎉
                        </span>
                    </div>
                </div>
                ...
                {activeTab === 'overview' && (
                    <div className="space-y-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <StatCard
                                label="Daily Usage"
                                value={`${profile?.dailyUsageCount || 0} / ∞`}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="glass p-6 rounded-2xl bg-gradient-to-br from-green-600 to-green-400 text-white flex flex-col justify-between overflow-hidden relative">
                                <div className="relative z-10">
                                    <h3 className="text-2xl font-black mb-2">Unlimited Access</h3>
                                    <p className="text-sm opacity-90 mb-6 max-w-[200px]">All features are now free 🎉. Enjoy unlimited AI generations and TravelMind AI.</p>
                                    <button className="bg-white text-green-600 px-6 py-2 rounded-full text-sm font-bold hover:scale-105 transition-transform">
                                        Enjoying the App!
                                    </button>
                                </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                                    <span className="font-medium">Unlimited Free Plan 🎉</span>
                                </div>
                            </div>
                        </div>
                    </div>
